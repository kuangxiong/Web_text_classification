...
def bert_get_text_id(BertModelConfig, train_text, max_length=BertModelConfig.max_len):
    """
    将训练集上的文字字符转化为字编号
...
def load_bert_dataset(GlobalConfig, max_length = BertModelConfig.max_len):
    """
    生成训练数据集合
    ...
    train_text, train_seg, train_label_id = bert_get_text_id(BertModelConfig, train_data,
