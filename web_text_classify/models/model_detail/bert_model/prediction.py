...
if __name__=='__main__':
    ...
    test_text, test_seg, test_id = load_bert_dataset(GlobalConfig, training=False, max_length = ModelConfig.max_len) 
    
    #model_file = os.path.join(GlobalConfig.save_path, "model.h")
    model = keras.models.load_model("save_model/bert_model.h5",
