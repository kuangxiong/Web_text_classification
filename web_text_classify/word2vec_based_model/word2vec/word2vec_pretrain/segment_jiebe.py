...
if __name__ == "__main__":
    ...
    file_dir = "./data/source/source_data/"
    segment_out_dir = "./data/segment"
    files_list = files_processing.get_files_list(file_dir, postfix="*.csv")
    print(1111, files_list)

    # segment_out_dir='data/segment_conbine.txt'
    # combine_files_content(files_list, segment_out_dir,stopwords)
    segment.batch_processing_files(
        files_list, segment_out_dir, batchSize=1000, stopwords=[]
    )
