...
def get_word_dict(train_data, test_data, N = ModelConfig.n_vocab):
    ...
    res_word_dict = sorted(tmpword_dict.items(),
...
def load_model_dataset(GlobalConfig, max_length=ModelConfig.max_len):
    ...
    if os.path.isfile(check_word_dict):
        ...
        word_dict = get_word_dict(
            train_data, test_data, N=ModelConfig.word_dict_num)

    train_text, tmp_train_id = get_text_id(
        word_dict, train_data, max_length=max_length)
