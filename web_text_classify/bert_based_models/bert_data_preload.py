...
class BertDataPreload(object):
    ...
    def bert_load_data(self, training=True):
        ...
        if training == True:
            train_text, train_seg, train_label_id = self.bert_get_text_id(
                train_data, training, max_length
            )
            ...
            test_text, test_seg, test_id = self.bert_get_text_id(
                test_data, training, max_length
            )
